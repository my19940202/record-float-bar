...
export const messages = {
  zh: {
    ...
    create: {
      ...
      title: '创建提纲',
      description: '输入主题和补充信息，让 DeepSeek 生成适合自媒体视频录制的提纲。文件上传暂不可用。',
      textTab: '文字输入',
      fileTab: '文件上传暂不可用',
      topic: '主题',
  ...
  en: {
    ...
    create: {
      ...
      description:
        'Enter a topic and notes so DeepSeek can generate an outline for creator videos. File upload is temporarily unavailable.',
      textTab: 'Text',
